...
const cardData = [
    {
        imgSrc: '../../assets/img/Features/featureOne.svg',
        heading: 'Menu variations',
        subheading: 'Sed ut perspiciatis unde omnis iste natus error',
        link: 'Learn more'
    },
    {
        imgSrc: '../../assets/img/Features/featureTwo.svg',
        heading: 'Cooking warw',
        subheading: 'Sed ut perspiciatis unde omnis iste natus error',
        link: 'Learn more'
    },
    {
        imgSrc: '../../assets/img/Features/featureThree.svg',
        heading: 'Best chef',
        subheading: 'Sed ut perspiciatis unde omnis iste natus error',
        link: 'Learn more'
    },
    {
        imgSrc: '../../assets/img/Features/featureFour.svg',
        heading: 'Fast food',
        subheading: 'Sed ut perspiciatis unde omnis iste natus error',
        link: 'Learn more'
    }
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-y-20 gap-x-5 mt-32">
                    <Fade direction="up" delay={1000} cascade damping={1e-1} triggerOnce={true}>
                        {cardData.map((item, index) => (
                            <div className="card-b p-8 relative rounded-3xl" key={index}>
                                <div className="work-img-bg rounded-full flex justify-center absolute top-[-50%] sm:top-[-40%] md:top-[-55%] lg:top-[-45%] left-[0%]">
                                    <Image src={item.imgSrc} alt={item.imgSrc} width={510} height={10} />
                                </div>
                                ...
                                <div className="flex items-center justify-center">
                                    <Link href="/">
                                        <p className="text-center text-lg font-medium text-pink mt-2 hover-underline">{item.link}<ChevronRightIcon width={20} height={20} /></p>
                                    </Link>
                                </div>
                            </div>
                        ))}
