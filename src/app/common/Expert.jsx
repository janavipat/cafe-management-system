...
const postData = [
    {
        ...
        name: 'Shoo Thar Mien',
        imgSrc: '../../assets/img/Expert/boyone.svg',
    },
    {
        profession: 'Junior Chef',
        name: 'Shoo Thar Mien',
        imgSrc: '../../assets/img/Expert/girl.png',
    },
    {
        profession: 'Junior Chef',
        name: 'Shoo Thar Mien',
        imgSrc: '../../assets/img/Expert/boytwo.svg',
    },
    {
        profession: 'Junior Chef',
        name: 'Shoo Thar Mien',
...
const MultipleItems = () => {
    ...
    return (
        <div className="py-10 sm:py-20 bg-darkpink"  style={{backgroundColor:"rgb(254 237 234)"}}>
                            ...
                            <div className="m-3 py-14 my-10 text-center">
                                <div className="relative">
                                    ...
                                    <div className="absolute top-[50%] right-[2%]">
                                        <img src="../../assets/img/Expert/Linkedin.svg" alt="linkedin" width={220} height={120} />
                                    </div>
                                </div>
