...
const Footer = () => {
  ...
  return (
    <footer
      style={{ backgroundColor: "#1a1a1a", color: "#fff", padding: "40px 0" }}
    >
      <div
        className="container"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Life begins after coffee, in the cozy embrace of a cafe's
              ambiance, where stories are shared and dreams take flight:
            </p>
            <div
          ...
          <div
            className="footer-widget"
            style={{ width: "100%", maxWidth: "20%", marginBottom: "20px" }}
          >
            <h4
              style={{
                marginBottom: "20px",
          ...
          >
            ...
            >
              ...
              <li
                style={{ marginBottom: "10px" }}
                onClick={() => handleService("Espresso")}
              >
                <Link href="/order" legacyBehavior>
                  <a style={{ textDecoration: "none", color: "#fff" }}>
                    Espresso
              ...
              <li
                style={{ marginBottom: "10px" }}
                onClick={() => handleService("Cappuccino")}
              >
                <Link href="/order" legacyBehavior>
                  <a style={{ textDecoration: "none", color: "#fff" }}>
                    Cappuccino
              ...
              <li
                style={{ marginBottom: "10px" }}
                onClick={() => handleService("Americano")}
              >
                <Link href="/order" legacyBehavior>
                  <a style={{ textDecoration: "none", color: "#fff" }}>
                    Americano
          ...
          <div
            className="footer-widget"
            style={{ width: "100%", maxWidth: "30%", marginBottom: "20px" }}
          >
            <h4
              style={{
                marginBottom: "20px",
        ...
        >
          <div className="copy-right" style={{ fontSize: "15px" }}>
            <span>
              ...
              <a
                href="https://github.com/janavipat"
                style={{
                  paddingLeft: "10px",
                  fontSize: "16px",
                  textDecoration: "none",
