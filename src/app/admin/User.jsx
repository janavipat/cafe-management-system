...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Select, MenuItem, Typography, Grid, CircularProgress, Button } from '@mui/material';
...
const User = () => {
  ...
  const handleStatusChange = async (userId, newStatus) => {
    try {
      await axios.put(`http://localhost:5000/user/users/${userId}/status`, { status: newStatus },
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  return (
    <Grid container spacing={2} direction="column" alignItems="center">
      ...
      <Grid item xs={12} md={10} sx={{marginLeft:"40px", width:"1200px", marginTop:"70px"}}>
